...
\newcommand{\letfgfv}{\letfg\ and let $\parenth{V, \rho}$ be a finite-dimensional representation of $G$}
\newcommand{\letfgfnzv}{\letfg\ and let $\parenth{V, \rho}$ be a finite-dimensional, non-zero representation of $G$}
...
\newcommand{\CHM}{$\C H$-module}
\newcommand{\CGHM}{$\C\parenth{G \times H}$-module}
