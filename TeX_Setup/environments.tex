...
\newenvironment{boxproblem}{
    \begin{tcolorbox}[colback=orange!3!white,colframe=orange!70!black, breakable, enhanced]\begin{problem}
}{
    \end{problem}\end{tcolorbox}
}
\newenvironment{boxtheorem}{
    \begin{tcolorbox}[colback=green!3!white,colframe=green!70!black, breakable, enhanced]\begin{theorem}
}{
...
\newenvironment{boxexample}{
    \begin{tcolorbox}[breakable, enhanced]\begin{example}
}{
